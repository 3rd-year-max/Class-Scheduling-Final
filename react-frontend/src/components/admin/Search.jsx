    ...
    <div className="dashboard-container" style={{ display: 'flex' }}>
      ...
      <main className="main-content" style={{ flex: 1, padding: '1rem' }}>
        ...
        <div className="dashboard-content" style={{ marginTop: '140px' }}>
          <h2 style={{ margin: '0 0 8px 0', fontSize: '24px', fontWeight: '700', color: '#ffffff' }}>Search Results</h2>
          <p style={{ margin: '0 0 24px 0', color: '#ffffff', fontSize: '14px', fontWeight: '500' }}>Search query: <strong>"{q}"</strong></p>
          {loading && (
